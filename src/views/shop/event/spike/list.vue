    ...
    <div class="md-bargain-list" v-loading="loading">
        ...
        <div class="main-container">
            <el-form @submit.native.prevent="getData(true)" inline>
                ...
                <el-form-item>
                    ...
                    <el-button type="primary" v-if="$util.checkPermission('event', ['c'])"
                               @click="$router.push({name: 'EventSpikeAdd'})">创建活动
                    </el-button>
                </el-form-item>
            </el-form>
            ...
            <el-table :data="table.data" border>
                ...
                <el-table-column label="开始时间" align="center" prop="name">
                    <template slot-scope="scope">
                        {{scope.row.startTime | dateFilter}}
                    </template>
                </el-table-column>
                <el-table-column label="结束时间" align="center" prop="name">
                    <template slot-scope="scope">
                ...
                <el-table-column label="管理" align="center">
                    <template slot-scope="scope">
                        <el-button type="text" @click="edit(scope.row)" :disabled="scope.row.startTime < unixTime">编辑
                        </el-button>
                        <el-button type="text" @click="getItems(scope.row)">禁用或启用商品</el-button>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            edit(item) {
                this.$router.push({name: 'EventSpikeEdit', params: {id: item.id}})
            },
            getItems(row) {
                this.loading = true;
